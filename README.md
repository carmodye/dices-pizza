...
Once you've opened your browser to the application, you can use the register link to create an account and view the seeded pizza orders.# lavaravel_react
